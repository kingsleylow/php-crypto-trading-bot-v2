                 ...
                 if (IsValidJSONString(msg.data)) {
                     ...
                     if (cmnd_sent === 'latestScansData') {
                         ...
                         stratsNames.forEach(function (stratName) {
							 ...
							 global_prices[coinName] = data_array[stratName][coinName]['price'].toFixed(8);
							 }
												 );
						 });
							 return null;
...
<td data-title="Purchase Price">Purchase Price</td>
                        ...
                        change panel-success according to profit/loss stat
                         ...
                         //alert(cmnd_answr);
						 if(typeof cmnd_answr === "undefined" || typeof cmnd_answr === "null" ){
							 console.log(data_jsoned);
							 return false;
						 }
...
ik=0;
                             ...
                             console.log(signal);
                             strategyName = signal.details.startegy;
